...
!function($s) {
  ...
  var createSwitchFactory = function(type) {
    return function(device) {
      ...
      if ((type == 'Toggle' || type == 'VToggle') && device.deviceDef.state) {
        on = device.deviceDef.state.on;
      }
      device.getState = function() {
        return (type == 'Toggle' || type == 'VToggle')? { on : on } : null;
      };
      ...
      device.createUI = function() {
        ...
        if ((type == 'Toggle' || type == 'VToggle') && on) {
        ...
        var button_mouseDownHandler = function(event) {
          ...
          if (type == 'PushOn') {
            ...
            on = false;
            $button.addClass('simcir-basicset-switch-button-pressed');
          } else if ((type == 'Toggle' || type == 'VToggle')) {
            on = !on;
            $button.addClass('simcir-basicset-switch-button-pressed');
          }
          updateOutput();
  ...
  */
  ...
  $s.registerDevice('VToggle', createSwitchFactory('VToggle') );
