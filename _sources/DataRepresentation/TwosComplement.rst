...
.. raw:: html
    ...
    <p>2,000,000,000 * 2 = <script>document.writeln((2000000000 * 2) | 0);</script> <br/> (Should be 4,000,000,000 but we wrapped around to negative.)</p>
    <p>-2,000,000,000 + -500,000,000 = <script>document.writeln((-2000000000 + -500000000) | 0);</script> <br/> (Should be -2,500,000,000 but we wrapped back around to positive.)</p>
...
.. mchoice:: twoscomplement_2
    ...
    :feedback_c: 01111 = 15.
    :feedback_d: Remember that the first digit is the sign. It must be 0.
