...
The Little Computer is designed to explore how a computer works at a low level. Rather than use binary, it uses decimal numbers to represent data and instructions to make it a little easier for a human to see what is going on. But other than that, it is a relatively accurate, if very simple, simulation of a computer. 
