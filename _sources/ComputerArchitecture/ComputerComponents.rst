...
You may already be familiar with the basic parts of a computer. Below is a picture of a desktop PC with some of the key components labeled:

.. figure:: Images/Personal_computer.png
    :width: 60%
    :alt: A personal computer
    
    `Image via Wikipedia Commons <http://commons.wikimedia.org/wiki/File:Personal_computer,_exploded_5.svg#mediaviewer/File:Personal_computer,_exploded_5.svg>`__ - `Creative Commons CC BY 2.5 <http://creativecommons.org/licenses/by/2.5>`__
...
.. figure:: Images/vonNeumannData.png
    :width: 80%
    :alt: Data Flow in a Computer
    
    `Image via Wikipedia Commons <http://en.wikibooks.org/wiki/IB/Group_4/Computer_Science/Computer_Organisation#mediaviewer/File:Data_flow_through_a_von_Neumann_machine.svg>`__ - `Creative Commons CC BY SA 3.0 <http://creativecommons.org/licenses/by-sa/3.0/>`__
