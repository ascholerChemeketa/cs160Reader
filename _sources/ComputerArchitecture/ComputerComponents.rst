...
.. figure:: Images/Personal_computer.png
    ...
    `Image via Wikipedia Commons <http://commons.wikimedia.org/wiki/File:Personal_computer,_exploded_5.svg#mediaviewer/File:Personal_computer,_exploded_5.svg>`_ - `Creative Commons CC BY 2.5 <http://creativecommons.org/licenses/by/2.5>`_
...
.. figure:: Images/vonNeumannData.png
    ...
    `Image via Wikipedia Commons <http://en.wikibooks.org/wiki/IB/Group_4/Computer_Science/Computer_Organisation#mediaviewer/File:Data_flow_through_a_von_Neumann_machine.svg>`_ - `Creative Commons CC BY SA 3.0 <http://creativecommons.org/licenses/by-sa/3.0/>`_
