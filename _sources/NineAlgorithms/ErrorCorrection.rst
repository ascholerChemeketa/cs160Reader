...
Book ISBN numbers are validated with a stair step code. You will build a program to do this later on in the course, but if you are interested you can `read about how the validation works here <http://www-math.ucdenver.
