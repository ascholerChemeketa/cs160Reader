...
.. sidebar:: *nix
    ...
    There are many "flavors" of UNIX and operating systems based on UNIX (sometimes refereed to as "*nixes"). Apple's OSX is related to a flavor of UNIX. Linux is a free Unix-like operating system.
