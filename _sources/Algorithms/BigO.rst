...
* Constant : :math:`O(1)`
    ...
    * Looking at a class roster and deciding if there are any students enrolled - I can say "Yes" or "No" in the same time whether there are 0 names, 3 names or 100 names on the roster.
